...
dma_copy_dpu(char *export_desc_file_path, char *buffer_info_file_path, struct doca_pci_bdf *pcie_addr)
{
	...
	int event_count = 0;
		...
		// Even though this polls for completion, since event got generated, it should not spin a lot
	...
	printf("Blocking DMA write (D-to-H) (event_epoll)\n");
